...
const DISCORD_INVITE = 'https://discord.gg/vePAuEYp';
        ...
        <div className="flex items-center justify-between gap-3 flex-wrap">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-white/70">
              You're early! We ship updates daily.
            </span>
          </div>
          <a
            href={DISCORD_INVITE}
        ...
        <div className="flex items-center justify-center gap-4 flex-wrap">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-white/80">
              <strong className="text-white">You're early!</strong> We ship updates daily. Stick with us – the best is coming.
            </span>
          </div>
          <a
            href={DISCORD_INVITE}
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#5865F2] hover:bg-[#4752C4] text-white text-sm font-medium transition-colors shadow-lg shadow-[#5865F2]/25"
          >
            <MessageCircle className="w-4 h-4" />
            Join Discord
          </a>
