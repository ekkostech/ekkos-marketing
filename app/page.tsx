...
export default function HomePage() {
  ...
  // Pricing tiers based on blueprint
  const tiers = [
    {
      name: 'Echo',
      tier: 'Free',
  ...
  return (
    <>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="mb-6 animate-fade-in-up">
            <h1 className="text-7xl md:text-9xl lg:text-[10rem] font-bold tracking-tight">
              ...
              <sup className="text-2xl md:text-3xl lg:text-4xl bg-gradient-to-r from-purple-400 via-blue-400 to-purple-500 bg-clip-text text-transparent align-super ml-1">™</sup>
            </h1>
          </div>

          {/* Badges */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/30 animate-fade-in-up backdrop-blur-sm" style={{ animationDelay: '0.1s' }}>
              <Database className="w-4 h-4 text-emerald-400 animate-pulse" />
              <span className="text-sm text-emerald-300 font-medium">Starts at 2x. Accelerates to 10x+.</span>
            </div>
            <Link
              href="/security"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-500/10 border border-green-500/30 hover:bg-green-500/20 transition-colors animate-fade-in-up backdrop-blur-sm"
              style={{ animationDelay: '0.15s' }}
            >
              <Lock className="w-4 h-4 text-green-400" />
              <span className="text-sm text-green-300 font-medium">SOC 2 Compliant, Certification in Progress</span>
            </Link>
          </div>

          {/* Headline - Canonical One-Liner */}
          <h2 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <span className="bg-gradient-to-r from-white via-white to-white/70 bg-clip-text text-transparent">
              ekkOS is a cognitive infrastructure platform that gives AI agents, developer tools, and applications persistent memory, reusable know-how, and continuity across projects.
            </span>
          </h2>

          {/* Subheadline */}
          <p className="text-xl md:text-2xl text-white/70 max-w-3xl mx-auto mb-4 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
            ekkOS separates memory, intent, and execution so AI systems can learn safely over time.
          </p>
          
          {/* Growth Timeline Badge */}
          <div className="max-w-3xl mx-auto mb-8 animate-fade-in-up" style={{ animationDelay: '0.35s' }}>
            <div className="inline-flex items-center gap-3 px-6 py-3 rounded-xl bg-gradient-to-r from-purple-500/20 via-blue-500/20 to-emerald-500/20 border border-purple-500/30 backdrop-blur-sm">
              <TrendingUp className="w-5 h-5 text-purple-400" />
              <div className="text-center">
                <div className="text-sm font-semibold text-white">
                  Week 1: Solve first problems | Month 1: 5-7x | Month 3: 10-15x
                </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            <Link
              ...
              className="group flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-purple-500 to-blue-500 rounded-xl font-semibold hover:from-purple-600 hover:to-blue-600 transition-all shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 hover:scale-105"
            >
              Get Started Free
            ...
            <a
              href="#how-it-works"
              className="flex items-center gap-2 px-8 py-4 bg-white/5 border border-white/10 rounded-xl font-semibold hover:bg-white/10 hover:border-white/20 transition-all hover:scale-105"
            >
              See How It Works
            </a>
          </div>
          ...
          <div className="max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
            <div className="bg-gradient-to-br from-purple-500/10 via-blue-500/10 to-purple-500/10 rounded-2xl border border-purple-500/30 p-8 shadow-2xl hover:shadow-purple-500/20 transition-shadow">
              <div className="flex items-center gap-3 mb-4">
                <Code2 className="w-8 h-8 text-purple-400" />
                <div>
                  <h3 className="text-xl font-bold text-white">Get Started in 3 Clicks</h3>
                  <p className="text-sm text-white/60">Install ekkos-connect for VS Code</p>
                </div>
              </div>
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center gap-3 text-white/80">
                  ...
                  <span>One-click authentication with your ekkOS account</span>
                </div>
                <div className="flex items-center gap-3 text-white/80">
                  <CheckCircle2 className="w-5 h-5 text-green-400 flex-shrink-0" />
                  <span>Automatic configuration - no manual setup required</span>
                </div>
                <div className="flex items-center gap-3 text-white/80">
                  <CheckCircle2 className="w-5 h-5 text-green-400 flex-shrink-0" />
                  <span>Works instantly with Claude Code & Cursor AI</span>
                </div>
              </div>

              <a
                href="vscode:extension/ekkos.ekkos-connect"
                className="group flex items-center justify-center gap-2 w-full px-6 py-4 bg-gradient-to-r from-purple-500 to-blue-500 rounded-xl font-semibold hover:from-purple-600 hover:to-blue-600 transition-all shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 hover:scale-105"
              >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-white/60 max-w-3xl mx-auto">
              Real metrics showing how ekkOS compounds over time. Not static numbers—actual growth.
            </p>
          </div>
      ...
      <section className="py-24 px-6 bg-gradient-to-b from-transparent to-purple-500/5" id="how-it-works">
        <div className="max-w-6xl mx-auto">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-3xl md:text-5xl font-black tracking-tight">
              <span className="bg-gradient-to-r from-purple-400 via-blue-400 to-purple-500 bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient-shift">
      ...
      <section className="py-24 px-6" id="capabilities">
        <div className="max-w-5xl mx-auto">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-white/60 max-w-3xl mx-auto">
              Powerful capabilities that happen automatically behind the scenes.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {capabilities.map((cap, i) => (
              <GlassCard key={cap.name} variant="elevated" hover="lift" delay={i * 0.05} className="p-6 text-center group">
                <div className={`w-12 h-12 mx-auto mb-4 rounded-xl bg-${cap.color}-500/20 flex items-center justify-center group-hover:scale-110 transition-transform`}>
                  <cap.icon className={`w-6 h-6 text-${cap.color}-400`} />
                </div>
                <div className="text-lg font-bold mb-3 text-white">{cap.name}</div>
                <div className="text-sm text-white/60 leading-relaxed">{cap.desc}</div>
              </GlassCard>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 px-6 bg-gradient-to-b from-blue-500/5 to-transparent" id="magic">
        <div className="max-w-6xl mx-auto">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-3xl md:text-5xl font-black tracking-tight">
              <span className="bg-gradient-to-r from-purple-400 via-blue-400 to-purple-500 bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient-shift">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <GlassCard variant="elevated" className="p-8 space-y-6">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-2xl font-bold text-white">Day 1: First Session</h3>
              </div>

              <div className="space-y-4">
                <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500">
                  <p className="text-sm text-white/60 mb-1">You ask:</p>
                  <p className="text-white">"Set up authentication with Supabase"</p>
                </div>

                <div className="p-4 rounded-lg bg-white/5 border-l-2 border-blue-500">
                  <p className="text-sm text-white/60 mb-1">Agent does the work, then ekkOS_ asks:</p>
                  <p className="text-white">"Remember this for next time?"</p>
                </div>

                <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500">
                  <p className="text-sm text-white/60 mb-1">You say "Yes" — and that decision is now:</p>
                  <p className="text-green-400 font-medium">Part of ekkOS_Forever_Memory™</p>
                </div>
              </div>
            </GlassCard>

            {/* Day 2 */}
            <GlassCard variant="prominent" glow="purple" className="p-8 space-y-6">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-green-500/20 flex items-center justify-center">
                  <span className="text-lg font-bold text-green-400">2</span>
                </div>
                <h3 className="text-2xl font-bold text-white">Day 2: The Magic</h3>
              </div>

              <div className="space-y-4">
                <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500">
                  <p className="text-sm text-white/60 mb-1">You ask:</p>
                  <p className="text-white">"Add password reset to our auth"</p>
                </div>

                <div className="p-4 rounded-lg bg-white/5 border-l-2 border-blue-500">
                  <p className="text-sm text-white/60 mb-1">ekkOS automatically:</p>
                  <p className="text-white/80 text-sm">
                    Applies your prior knowledge, matches your code style, and validates suggestions before showing them to you.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/30">
                  ...
                  <p className="text-white/80 text-sm">
                    "Matches your prior decisions. No conflicts with your preferences."
                  </p>
                </div>
              </div>
            </GlassCard>
            ...
            {/* Day 30 */}
            <GlassCard variant="prominent" glow="emerald" className="p-8 space-y-6 md:col-span-3 lg:col-span-1">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-emerald-500/20 flex items-center justify-center">
                  <span className="text-lg font-bold text-emerald-400">30</span>
                </div>
                <h3 className="text-2xl font-bold text-white">Day 30: Acceleration Phase</h3>
              </div>

              <div className="space-y-4">
                <div className="p-4 rounded-lg bg-gradient-to-r from-emerald-500/20 to-cyan-500/20 border border-emerald-500/30">
                  <div className="flex items-center justify-between mb-3">
                    <p className="text-sm text-white/60">Typical results after 1 month:</p>
                    <span className="text-xs px-2 py-0.5 rounded bg-amber-500/20 text-amber-300 border border-amber-500/30">Typical</span>
                  </div>
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-white/80 text-sm">Solutions learned</span>
                      <span className="text-lg font-bold text-emerald-400">Dozens</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-white/80 text-sm">Decisions retained</span>
                      <span className="text-lg font-bold text-cyan-400">Hundreds</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-white/80 text-sm">Average speedup</span>
                      <span className="text-lg font-bold text-purple-400">~5x</span>
                    </div>
                    <div className="flex items-center justify-between pt-2 border-t border-white/10">
                      <span className="text-white/80 text-sm">Projected month 3</span>
                      <span className="text-xl font-bold text-emerald-400">~10x</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-lg bg-white/5 border-l-2 border-emerald-500">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-emerald-400 font-medium text-sm">The Compound Effect</span>
                  </div>
                  <p className="text-white/80 text-sm">
                    You're shipping faster, making fewer mistakes, and the gap keeps widening.
                    Every problem solved is an investment in future speed.
                  </p>
                </div>
              </div>
            </GlassCard>
      ...
      {/* IDE Integrations */}
      <section className="py-24 px-6" id="integrations">
        <div className="max-w-5xl mx-auto">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-3xl md:text-5xl font-black tracking-tight">
              <span className="bg-gradient-to-r from-purple-400 via-blue-400 to-purple-500 bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient-shift">
      ...
      <section className="py-24 px-6 bg-gradient-to-b from-transparent via-cyan-500/5 to-transparent" id="gateway">
        <div className="max-w-5xl mx-auto">
          <div className="text-center space-y-4 mb-16">
      ...
      {/* For Solo Devs */}
      <section className="py-24 px-6 bg-gradient-to-b from-purple-500/5 to-transparent" id="individuals">
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <GlassCard variant="elevated" className="p-8 space-y-6">
              <h3 className="text-lg font-bold text-white">Community Knowledge (Live)</h3>
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 rounded-lg bg-white/5">
                  <span className="text-sm text-white/60">Solutions Learned</span>
                  <span className="text-xl font-bold text-white">
                    <AnimatedCounter value={stats.patterns} decimals={0} />
                  </span>
                </div>
                <div className="flex items-center justify-between p-4 rounded-lg bg-white/5">
                  <span className="text-sm text-white/60">Decisions Retained</span>
                  <span className="text-xl font-bold text-white">
                ...
                <div className="flex items-center justify-between p-4 rounded-lg bg-white/5">
                  ...
                  <span className="text-xl font-bold text-white">
                    <AnimatedCounter value={stats.memories} decimals={0} />
                  </span>
                </div>
              </div>
            </GlassCard>
      ...
      {/* For Teams */}
      <section className="py-24 px-6" id="teams">
        <div className="max-w-5xl mx-auto">
          <div className="text-center space-y-4 mb-16">
      ...
      <section className="py-24 px-6 bg-gradient-to-b from-emerald-500/5 to-transparent" id="firewall">
        <div className="max-w-5xl mx-auto">
          <div className="text-center space-y-4 mb-16">
      ...
      {/* Not Just Another Vector DB - Positioning */}
      <section className="py-24 px-6 bg-gradient-to-b from-transparent via-blue-500/5 to-transparent">
        <div className="max-w-5xl mx-auto">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-3xl md:text-5xl font-black tracking-tight">
          ...
          <div className="max-w-4xl mx-auto mb-12">
            <GlassCard variant="elevated" className="p-8">
              <p className="text-lg text-white/80 leading-relaxed mb-6">
                Traditional retrieval tools give you static results—the same answer every time,
                whether it worked or not. They require constant manual curation and have no way
                to learn from what actually succeeded.
              </p>
              <p className="text-lg text-white leading-relaxed">
                <span className="text-purple-400 font-semibold">ekkOS is different.</span> It learns
                from what actually worked, automatically captures solutions that succeed, and improves
                with real-world usage instead of repeating the same answers.
              </p>
            </GlassCard>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            <GlassCard variant="prominent" glow="purple" className="p-8 text-center">
              ...
              <p className="text-white/80 leading-relaxed">
                ekkOS builds <span className="text-purple-400 font-semibold">living memory</span> around your actual workflow,
                tied to real outcomes. It learns from experience to get smarter over time.
              </p>
              <div className="mt-6 pt-6 border-t border-white/10">
                <p className="text-sm text-white/60">
                  Static tools give you the same answer every time.
                  <span className="block mt-2 text-white font-medium">
                    ekkOS gives you the <em>right</em> answer, learned from what actually worked.
                  </span>
                </p>
              </div>
            </GlassCard>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {tiers.map((tier, i) => (
              ...
              >
                ...
                <div className="text-sm text-white/40 mb-1">{tier.tier}</div>
                <h3 className="text-2xl font-bold mb-2 text-white">{tier.name}</h3>
                <div className="text-4xl font-bold mb-2 text-white">
                  {tier.price}
                  <span className="text-lg text-white/40 font-normal">{tier.period}</span>
                </div>
      ...
      <section className="py-24 px-6 bg-gradient-to-b from-purple-500/5 to-transparent">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-sm text-white/50 mb-8">
            Free forever on Echo plan. No credit card required.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="https://platform.ekkos.dev/signup"
              className="group inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-purple-500 to-blue-500 rounded-xl font-semibold text-lg hover:from-purple-600 hover:to-blue-600 transition-all shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 hover:scale-105"
            >
              Get Started Free
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Link>
            <a
              href="#magic"
              className="flex items-center gap-2 px-8 py-4 bg-white/5 border border-white/10 rounded-xl font-semibold hover:bg-white/10 hover:border-white/20 transition-all"
            >
